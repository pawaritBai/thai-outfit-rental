                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                            @php
                                // Get current sizes
                                $currentSizes = isset($outfit->sizeAndColors) ? $outfit->sizeAndColors->pluck('size_id')->unique()->toArray() : [];
                            @endphp
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                            @php
                                // Get current colors
                                $currentColors = isset($outfit->sizeAndColors) ? $outfit->sizeAndColors->pluck('color_id')->unique()->toArray() : [];
                            @endphp
